...
function wpb_widgets_init() {
	...
	register_sidebar( array(
		 ...
		 'before_widget' => '<div class="top-head-logo">',
	...
	*/
	...
	$wp_customize->add_control( new gltheme_Text_Control(
		...
		array(
			...
			<p><a style="font-size: 14px;color: #ffffff;font-weight: 600;background-color: #51d2cb;border: 3px solid #51d2cb;border-radius: 5px;padding: 5px;text-decoration: none" href="https://wooskins.com/ws-perfume-wordpress-theme-document/" target="_blank" title="Read full theme document">Documentation</a>
